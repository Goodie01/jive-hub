...
public class UserDetail extends TableImpl<UserDetailRecord> {
     ...
     */
    public final TableField<UserDetailRecord, String> ORGANISATION_ID = createField(DSL.name("organisation_id"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.user_detail.display_name</code>.
     */
    public final TableField<UserDetailRecord, String> DISPLAY_NAME = createField(DSL.name("display_name"), SQLDataType.CLOB.nullable(false), this, "");
    ...
    public List<ForeignKey<UserDetailRecord, ?>> getReferences() {
        return Arrays.asList(Keys.USER_DETAIL__ORGANISATIONID_FK);
    }
     ...
     * <code>public.user_authentication</code> table
     */
    public UserAuthenticationPath userAuthentication() {
        if (_userAuthentication == null)
            _userAuthentication = new UserAuthenticationPath(this, null, Keys.USER_AUTHENTICATION__USERID_FK.getInverseKey());
