...
public class Parameters extends TableImpl<ParametersRecord> {
     ...
     */
    public final TableField<ParametersRecord, String> ORGANISATION_ID = createField(DSL.name("organisation_id"), SQLDataType.CLOB.nullable(false), this, "");
    ...
    public List<ForeignKey<ParametersRecord, ?>> getReferences() {
        return Arrays.asList(Keys.PARAMETERS__ORGANISATIONID_FK, Keys.PARAMETERS__USERID_FK);
    }
    ...
    public OrganisationPath organisation() {
        if (_organisation == null)
            _organisation = new OrganisationPath(this, Keys.PARAMETERS__ORGANISATIONID_FK, null);
    ...
    public UserDetailPath userDetail() {
        if (_userDetail == null)
            _userDetail = new UserDetailPath(this, Keys.PARAMETERS__USERID_FK, null);
