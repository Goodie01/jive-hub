...
public class Organisation extends TableImpl<OrganisationRecord> {
     ...
     */
    public final TableField<OrganisationRecord, String> ID = createField(DSL.name("id"), SQLDataType.CLOB.nullable(false), this, "");
    ...
    public UserDetailPath userDetail() {
        if (_userDetail == null)
            _userDetail = new UserDetailPath(this, null, Keys.USER_DETAIL__ORGANISATIONID_FK.getInverseKey());
